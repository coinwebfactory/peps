...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000ad70355adfd0cb677c6ae7ff7722b1cc6d8c69d925bdd2e3eabb1bffe2a"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1533805923, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("049d24b41ef28c662cd11719115ef34822518a4e1673e00d260bdfbc63cc31e137b4d924ec1e2840ce9290f2660a5a3311825374ece94a5549d5870c9eec116df0");
        nDefaultPort = 2777;
        ...
        const char* pszTimestamp = "Great food is like great sex. The more you have the more you want.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("048077716fafe138ccebe607d43b5f7c9e1f164ef54f8f103d86409169eaf8f872f8f57caca5359801a7ab82a67d78e598941096e68bb1a737479518ec7c743edf") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1533805923;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 4962361;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000ad70355adfd0cb677c6ae7ff7722b1cc6d8c69d925bdd2e3eabb1bffe2a"));
        assert(genesis.hashMerkleRoot == uint256("0xda72ad13f7b453a3c22144fbf3c5f1aebc2eb08f220847a080264859e7401f48"));
        ...
        vSeeds.push_back(CDNSSeedData("149.28.146.115", "149.28.146.115"));
        ...
        strSporkKey = "04FC45DF844C46D6E2A835D6D98449C30214ECA9AB3306100DDFBF8888A656D2E9E368190BD0C92AC06E233BCCC8A7DA34652E81A9EFEFDC42F5F90EE4F294C93F";
        strObfuscationPoolDummyAddress = "p8Rhy16zQ3SPqXKHT3rhdvCef8x3TUY6oj";
        nStartMasternodePayments = 1533805923;
    }
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 39793;
        // assert(hashGenesisBlock == uint256("0x00000d885e2813770fd59e71010b6b62a9b0609655109bf4e1b24c3bd524ae0c"));
