...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString versionText = QString(tr("Version v2.1.1.1-CORE")).arg(QString::fromStdString(FormatFullVersion()));
    ...
    QString copyrightTextPeps = QChar(0xA9) + QString(tr(" 2018 The PEPS Core developers"));
    ...
    pixPaint.setPen(QColor(18, 104, 129));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextPeps);
...
static void InitMessage(SplashScreen* splash, const std::string& message)
{
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        Q_ARG(QColor, QColor(18, 104, 129)));
}
