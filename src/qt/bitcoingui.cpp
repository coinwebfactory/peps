                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PEPSv2.0 Client") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PEPSv2.0 Client"), this);
    aboutAction->setStatusTip(tr("Show information about PEPSv2.0 Client"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the PEPSv2.0 Client help message to get a list with possible Peps command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PEPSv2.0 Client client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("PEPSv2.0 Client"); // default title
