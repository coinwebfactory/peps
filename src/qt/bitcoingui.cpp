                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Peps Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Peps address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and peps: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Peps Core"), this);
    aboutAction->setStatusTip(tr("Show information about Peps Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Peps"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Peps addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Peps addresses"));
    ...
    openAction->setStatusTip(tr("Open a Peps: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Peps Core help message to get a list with possible Peps command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Peps Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Peps network", "", count));
}
...
{
    QString strTitle = tr("Peps Core"); // default title
...
/** Creates context menu, its actions, and pepss up all the relevant signals for mouse events. */
