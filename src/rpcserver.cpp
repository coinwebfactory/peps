...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Peps features */
        {"peps", "masternode", &masternode, true, true, false},
        {"peps", "listmasternodes", &listmasternodes, true, true, false},
        {"peps", "getmasternodecount", &getmasternodecount, true, true, false},
        {"peps", "masternodeconnect", &masternodeconnect, true, true, false},
        {"peps", "masternodecurrent", &masternodecurrent, true, true, false},
        {"peps", "masternodedebug", &masternodedebug, true, true, false},
        {"peps", "startmasternode", &startmasternode, true, true, false},
        {"peps", "createmasternodekey", &createmasternodekey, true, true, false},
        {"peps", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"peps", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"peps", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"peps", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"peps", "getmasternodescores", &getmasternodescores, true, true, false},
        {"peps", "mnbudget", &mnbudget, true, true, false},
        {"peps", "preparebudget", &preparebudget, true, true, false},
        {"peps", "submitbudget", &submitbudget, true, true, false},
        {"peps", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"peps", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"peps", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"peps", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"peps", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"peps", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"peps", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"peps", "checkbudgets", &checkbudgets, true, true, false},
        {"peps", "mnsync", &mnsync, true, true, false},
        {"peps", "spork", &spork, true, true, false},
        {"peps", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"peps", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pepsd, or the -server option to peps-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> peps-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2888/\n";
}
