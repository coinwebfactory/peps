...
This mechanism has been integrated into Bitcore-Node-Peps which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Peps-Project/insight-api-peps#web-socket-api](https://github.com/Peps-Project/insight-api-peps#web-socket-api) 
* API: [https://github.com/Peps-Project/insight-api-peps#swifttx-transactions](https://github.com/Peps-Project/insight-api-peps#swifttx-transactions) 
...
By default, the Peps Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Peps Core daemon:
